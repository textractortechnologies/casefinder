Feature: Listing and reviewing pathology cases
  ...
  Scenario: Searching and listing pathology cases
    ...
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index                             |
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"search"=>"", "filter"=>"pending", "filter_by"=>"", "suggestion_filter"=>"all", "date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow"}                |
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow", "direction"=>"asc", "filter"=>"pending", "page"=>"1", "search"=>"", "sort"=>"accession_number", "suggestion_filter"=>"all"}      |
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow", "direction"=>"desc", "filter"=>"pending", "page"=>"1", "search"=>"", "sort"=>"accession_number", "suggestion_filter"=>"all"}     |
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow", "direction"=>"asc", "filter"=>"pending", "page"=>"1", "search"=>"", "sort"=>"collection_date", "suggestion_filter"=>"all"}       |
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow", "direction"=>"desc", "filter"=>"pending", "page"=>"1", "search"=>"", "sort"=>"collection_date", "suggestion_filter"=>"all"}      |
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow", "direction"=>"asc", "filter"=>"pending", "page"=>"1", "search"=>"", "sort"=>"suggested_histologies", "suggestion_filter"=>"all"} |
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow", "direction"=>"desc", "filter"=>"pending", "page"=>"1", "search"=>"", "sort"=>"suggested_histologies", "suggestion_filter"=>"all"}|
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow", "direction"=>"asc", "filter"=>"pending", "page"=>"1", "search"=>"", "sort"=>"suggested_sites", "suggestion_filter"=>"all"}       |
    | example.user@test.com | VALUE: AccessAudit.controller_action_access     | pathology_cases:index with params: {"date_filter_type"=>"imported", "date_from"=>"DATE: Date.today", "date_to"=>"DATE: Date.tomorrow", "direction"=>"desc", "filter"=>"pending", "page"=>"1", "search"=>"", "sort"=>"suggested_sites", "suggestion_filter"=>"all"}      |
