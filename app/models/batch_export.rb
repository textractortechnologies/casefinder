class BatchExport < ActiveRecord::Base
  ...
  EXPORT_TYPE_FULL = 'full'
  EXPORT_TYPES = [EXPORT_TYPE_SIMPLE, EXPORT_TYPE_FULL]
  ...
  def self.to_metriq(abstractor_abstraction_groups, export_type)
    MetriqDocument.new(abstractor_abstraction_groups, export_type).generate
  end
end