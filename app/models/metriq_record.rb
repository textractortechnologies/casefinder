class MetriqRecord < Fixy::Record
  ...
  def initialize(patient_last_name, patient_first_name, primary_site_icd_o_3, medical_record_number, social_security_number, addr_no_and_street, city, state, zip_code, telephone, birth_date, sex)
